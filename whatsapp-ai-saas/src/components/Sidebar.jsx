        ...
        <div className="flex relative h-full shrink-0 group/sidebar" style={{ width: `${sidebarWidth}px`, transition: 'width 0.1s' }}>
            <aside className="w-full flex-col bg-sidebar-dark rounded-lg shadow-soft overflow-hidden shrink-0 text-white flex h-full">
                ...
                <nav className="flex-1 overflow-y-auto scrollbar-hide py-4 px-3 space-y-1">
                    ...
                    <Link to="/agents" className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors group ${currentPath === '/ai-chat' ? 'bg-primary/20 text-primary border border-primary/20' : 'text-gray-300 hover:bg-white/5 hover:text-white'}`}>
                    ...
                    <Link to="/agents" className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors group ${currentPath === '/ai-writer' ? 'bg-primary/20 text-primary border border-primary/20' : 'text-gray-300 hover:bg-white/5 hover:text-white'}`}>
