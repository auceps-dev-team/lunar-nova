...
const Support = () => {
    ...
    const changelog = [
        { version: 'v1.34.1', date: 'Aujourd\'hui', changes: ['Correction : suppression de 3 modèles NVIDIA obsolètes (Gemma 3N E2B/E4B ne répondaient plus, Kimi K2 retiré par NVIDIA)', 'Remplacement du modèle de secours par défaut par un modèle vérifié disponible (Llama 3.1 8B)'] },
