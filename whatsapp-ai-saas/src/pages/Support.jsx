...
const Support = () => {
    ...
    const changelog = [
        { version: 'v1.33.1', date: 'Aujourd\'hui', changes: ['Nouveau système de prospection (Annuaires CI & Go Africa)', 'Recherche sur Google Maps en temps réel', 'Extraction asynchrone et intelligente de numéros et adresses'] },
