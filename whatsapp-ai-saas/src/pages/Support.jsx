...
const Support = () => {
    ...
    const changelog = [
        { version: 'v1.42.14', date: '2026-08-26', changes: ['Nouveau : bouton « Supprimer la clé » (🗑️) dans les Réglages pour effacer proprement une clé API', 'Infrastructure : intégration continue GitHub Actions (lint, tests automatisés, build)', 'Centralisation des constantes OpenRouter et mise à jour du modèle Gemini par défaut (gemini-2.5-flash)', 'Nettoyage des variables d\'environnement et des canaux IPC obsolètes'] },
        { version: 'v1.42.13', date: '2026-08-26', changes: ['Sécurité : suppression de l\'écriture directe WordPress — tout passe désormais par le flux de validation humaine (HITL)'] },
