...
const Support = () => {
    ...
    const changelog = [
        { version: 'v1.34.2', date: 'Aujourd\'hui', changes: ['Correction du tracking des messages WhatsApp suite à la refonte de l\'interface WhatsApp Web (nouveaux sélecteurs, ancrage sur les identifiants internes plutôt que sur les classes CSS)', 'Correction de la détection du sens des messages qui faisait apparaître les suggestions du Copilote comme des réponses de l\'interlocuteur au lieu des vôtres'] },
