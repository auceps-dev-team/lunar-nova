...
import { CURRENCIES, STATUS_MAP, EMPTY_ARRAY, EMPTY_OBJECT } from '../components/invoice/constants';
import InvoiceDashboard from '../components/invoice/InvoiceDashboard';

/* ═══════════════════════════════════════════════════════
   CONSTANTS (CURRENCIES, STATUS_MAP, EMPTY_ARRAY/OBJECT)
   déplacées dans src/components/invoice/constants.js
   ═══════════════════════════════════════════════════════ */
...
export default function InvoiceBuilder({ activeId }) {
    ...
    // handleEdit : utilisé par la vue liste (InvoiceDashboard) pour rouvrir
